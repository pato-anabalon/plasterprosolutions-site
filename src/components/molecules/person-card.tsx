...
export function PersonCard({
  ...
  return (
    ...
    >
      <div
        className="grid size-16 shrink-0 place-items-center rounded-full bg-charcoal text-xl font-black text-white transition duration-300 group-hover:bg-spicy-orange"
        data-testid="person-card-initials"
      >
        {getInitials(name)}
      </div>
      <div>
        <div className="flex flex-wrap items-center gap-3">
          <h3 className="text-2xl font-black text-charcoal" data-testid="person-card-name">
            {name}
          </h3>
