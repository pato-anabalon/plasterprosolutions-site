...
export function ContactPersonCard({
  ...
  return (
    <article className="rounded-lg border border-charcoal/10 bg-surface p-4 shadow-[0_14px_34px_rgb(25_23_20/0.06)] transition duration-200 hover:-translate-y-0.5 hover:border-spicy-orange/40 hover:shadow-[0_20px_46px_rgb(25_23_20/0.1)]">
      <div>
        <h4 className="text-lg font-black leading-tight text-charcoal">
          {name}
        </h4>
