    ...
    >
      {previousPost ? (
        ...
        >
          ...
          <span className="mt-3 block text-xl font-black text-foreground">
            {previousPost.title}
          </span>
        </Link>
      ) : (
      ...
      <div className="site-shell grid gap-8 lg:grid-cols-[1fr_auto] lg:items-end">
        <div>
          ...
          <p className="mt-5 max-w-2xl text-lg leading-8 text-white/78">
            Send the project details and the PlasterPro Solution team will help
            scope the next step clearly.
          </p>
        </div>
