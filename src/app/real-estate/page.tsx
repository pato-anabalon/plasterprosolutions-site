  ...
  return (
    <>
      <InnerPageHero
        ...
        body="A focused landing page for teams who need homes, rentals, and listings to look quality before photography, viewings, inspections, and tenant handover."
          ...
          <div className="grid gap-8 p-8 sm:p-10 lg:grid-cols-[1fr_auto] lg:items-center">
            <div>
              ...
              <p className="pretty mt-4 max-w-2xl text-lg leading-8 text-white/72">
                Share the property address, target date, access notes, and
                visible issues. The team will respond through the main quote
                workflow.
              </p>
            </div>
