...
export const metadata: Metadata = {
  title: "About",
  description:
    "Learn about PlasterProSolutions, an Auckland plastering and painting team with more than 20 years of industry experience.",
};
        ...
        <div className="site-shell grid gap-12 lg:grid-cols-[1fr_0.85fr] lg:items-start">
          <div>
            <SectionHeading
              ...
              body="PlasterProSolutions supports homeowners, builders, commercial teams, agents, and property managers with reliable communication and detailed finishing work."
            />
            ...
            <div className="mt-8 grid gap-4 sm:grid-cols-2">
              <div className="flex gap-4 border-t border-charcoal/10 pt-5">
                <UsersRound className="mt-1 shrink-0 text-spicy-orange" size={24} aria-hidden="true" />
                <p className="pretty text-lg font-bold leading-8 text-charcoal">
                  Structured for homeowners and trade partners who need the same thing: fewer surprises on site.
                </p>
              </div>
              <div className="flex gap-4 border-t border-charcoal/10 pt-5">
                <Award className="mt-1 shrink-0 text-spicy-orange" size={24} aria-hidden="true" />
                <p className="pretty text-lg font-bold leading-8 text-charcoal">
                  Certification, product familiarity, and repeatable preparation help keep finish quality consistent.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="mt-6 grid grid-cols-2 gap-4">
              {siteConfig.certifications.map((item) => (
                <div
                  ...
                  key={item.name}
                >
                  <Image src={item.src} alt={item.name} width={150} height={70} />
                </div>
              ))}
            </div>
          </div>
