...
const proofPoints = [
  {
    value: "900+",
    label: "projects completed across Auckland since 2021",
  },
  {
    value: "20+",
    label: "years of hands-on trade experience",
  },
  {
    value: "20",
    label: "active sites supported across the region",
  },
];
...
export default function AboutPage() {
  return (
    <>
      ...
      <AboutProofStrip proofPoints={proofPoints} />
      <AboutStorySection
        completedProjectImage={siteConfig.projectGallery[0].image}
        values={values}
      />
