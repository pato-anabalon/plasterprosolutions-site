...
export const teamMembers: TeamMember[] = [
  {
    ...
    outsideWork: 'Fishing, traditional Chilean-style barbecues, movies, and camping around New Zealand.'
  },
  {
    name: "Regan O'keefe",
    ...
    imagePosition: 'center top',
    shortBio: 'Connects technical knowledge, sales, quoting, and project planning for practical client outcomes.',
    ...
    outsideWork: 'Running, fishing, reading, and exploring new cultures, languages, and cuisines.'
  },
  {
    name: 'Pablo Riquelme',
  ...
  },
  {
    ...
    imagePosition: 'center top',
    shortBio: 'Coordinates teams, materials, logistics, and delivery across active plastering and painting sites.',
    ...
    outsideWork: 'Anime, video games, family time, sports, and exploring new places across New Zealand.'
  },
  {
    ...
    imagePosition: 'center top',
    shortBio: 'Brings organisation, attention to detail, and a team-first mindset to plastering work.',
    ...
    outsideWork: 'Bodyboarding, football, hiking, and spending time at the beach.'
  },
  {
    ...
    imagePosition: 'center top',
    shortBio: 'A detail-focused plasterer with a practical background in supervision, construction, and carpentry.',
  ...
  },
  {
    ...
    imagePosition: 'center top',
    shortBio: 'Adds safety awareness, operational discipline, and a collaborative mindset to the site team.',
    ...
    outsideWork: 'Family time with his daughter, video games, anime, and exploring New Zealand parks.'
  },
  {
    ...
    imagePosition: 'center top',
    shortBio: "Shapes the company's digital presence, content strategy, and brand communication.",
